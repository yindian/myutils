...
hi StatusLineNC guifg=grey guibg=black	ctermfg=grey ctermbg=black
hi VertSplit guifg=grey guibg=black	ctermfg=grey ctermbg=black
hi OL1 guifg=grey	ctermfg=grey
hi OL2 guifg=red	ctermfg=red
hi OL3 guifg=lightblue	ctermfg=lightblue
hi OL4 guifg=violet	ctermfg=magenta
hi OL5 guifg=grey	ctermfg=grey
hi OL6 guifg=red	ctermfg=red
hi OL7 guifg=lightblue	ctermfg=lightblue
hi OL8 guifg=violet	ctermfg=magenta
hi OL9 guifg=grey	ctermfg=grey
